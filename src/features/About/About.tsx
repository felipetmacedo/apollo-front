				...
				<div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-64">
					<div className="max-w-2xl">
						...
						<p className="text-xl text-gray-200 mb-4">
							Tenha mais tranquilidade na hora de atender seu cliente com o software Apollo.
						</p>
						<p className="text-lg text-gray-300 mb-8">
							A combinação entre tecnologia e facilidades de uso para manter seu escritório automatizado e eficiente do início ao fim. Tudo em um só lugar acessível de onde estiver.
						</p>
